...
When you load the R project with RStudio, pay attention to the message in the console; you'll be informed of the R packages used for this project by running renv::status(). To install exactly the same version of R packages, you can type renv::restore().
