...
When loading the R project with RStudio, pay attention to the message in the console, you will be inform of the R packages used for this project by runnin renv::status(). To actually install the same exact R packges version, then you could type renv::restore().
